...
import blocks_world_operators_p2
print('')
print_operators()

import blocks_world_methods3_p2
print('')
print_methods()
...
pyhop(state3,[('move_blocks', goal3)], verbose=3)
multi_pyhop(state3, [('move_blocks', goal3)], 10, verbose=3)
