...
pyhop2.declare_operators(walk, call_taxi, ride_taxi, pay_driver)
print('')
pyhop2.print_operators()
...
pyhop2.pyhop(state1,[('travel','me','home','park')],verbose=1)

print('- If verbose=2, Pyhop also prints a note at each recursive call:')
pyhop2.pyhop(state1,[('travel','me','home','park')],verbose=2)

print('- If verbose=3, Pyhop also prints the intermediate states:')
pyhop2.pyhop(state1,[('travel','me','home','park')],verbose=3)
